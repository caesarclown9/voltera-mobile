...
**Версия приложения:** 1.0.1 (Build 85+)
**Версия бэкенда:** 1.2.4
...
| ------------------------ | ---------------------- | ------------------------- | ------------------ |
| **Аутентификация (JWT)** | ✅ HS256 + RS256/ES256 | ✅ Supabase Auth          | ✅ РАБОТАЕТ        |
...
- [x] Google Play compliance (16KB pages, edge-to-edge, large screens) ✅
- [x] Опубликовано в Google Play ✅
...
**Дата:** 2025-12-01 (обновлено)
**Версия мобильного приложения:** 1.0.1 (Build 85+)
**Версия бэкенда:** 1.2.4
