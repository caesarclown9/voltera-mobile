...
VALUES
  ('loc_1', 'Voltera Бишкек Центр', 'ул. Киевская 114', 'Бишкек', 42.8746, 74.5698, NOW(), NOW()),
  ('loc_2', 'Voltera Филармония', 'пр. Чуй 253', 'Бишкек', 42.8775, 74.6036, NOW(), NOW()),
  ('loc_3', 'Voltera Ала-Арча', 'ул. Ахунбаева 98', 'Бишкек', 42.8486, 74.5947, NOW(), NOW()),
  ('loc_4', 'Voltera Ош Базар', 'ул. Абдрахманова 134', 'Бишкек', 42.8674, 74.5916, NOW(), NOW()),
  ('loc_5', 'Voltera Дордой Плаза', 'ул. Ибраимова 115', 'Бишкек', 42.8754, 74.6142, NOW(), NOW()),
  ('loc_6', 'Voltera Ош Центр', 'ул. Ленина 331', 'Ош', 40.5283, 72.7985, NOW(), NOW()),
  ('loc_7', 'Voltera Ош Аэропорт', 'ул. Масалиева 23', 'Ош', 40.6089, 72.7935, NOW(), NOW()),
  ('loc_8', 'Voltera Джалал-Абад', 'ул. Токтогула 28', 'Джалал-Абад', 40.9332, 72.9801, NOW(), NOW())
