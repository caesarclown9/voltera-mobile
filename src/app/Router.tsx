...
import { routes, prefetchCriticalRoutes, prefetchRelatedRoutes } from './LazyRoutes'
    ...
    <>
      ...
      <Suspense fallback={<LoadingScreen />}>
        <Routes>
          ...
          <Route path="/charging/:stationId" element={<routes.ChargingPage.component />} />
          <Route path="/charging-process/:sessionId" element={<routes.ChargingProcessPage.component />} />
          <Route path="/charging-complete/:sessionId" element={<routes.ChargingCompletePage.component />} />
          <Route path="/favorites" element={<routes.StationsList.component />} />
