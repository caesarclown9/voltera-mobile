...
export const ChargingCompletePage = () => {
  ...
  const [sessionData, setSessionData] = useState<ChargingCompleteData | null>(null);
        ...
        if (savedData) {
          ...
          if (response.success && response.session) {
            setSessionData({
              ...
              duration: response.session.charging_duration_minutes * 60 || 0,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white pb-20">
      ...
      <div className="px-4 py-6 max-w-md mx-auto">
        ...
        <h2 className="text-2xl font-bold text-center mb-2">Зарядка успешно завершена!</h2>
        <p className="text-gray-600 text-center mb-6">Спасибо за использование EvPower</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          ...
          {sessionData.evBatterySoc !== undefined && (
            <div className="flex items-center justify-between py-3 border-b border-gray-100">
              ...
              <span className="font-semibold text-lg">{Math.round(sessionData.evBatterySoc)}%</span>
            </div>
          )}
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100">
            ...
            <span className="font-semibold text-lg">{sessionData.energyDelivered.toFixed(2)} кВт·ч</span>
          </div>
          ...
          <div className="flex items-center justify-between py-3 border-b border-gray-100">
            ...
            <span className="font-semibold text-lg">{formatTime(sessionData.duration)}</span>
          </div>
          ...
          <div className="flex items-center justify-between py-3 bg-cyan-50 -mx-6 px-6 mt-3 rounded-xl">
            ...
            <span className="font-bold text-2xl text-cyan-600">{sessionData.totalCost.toFixed(2)} KGS</span>
          </div>
        </div>
